...
Olá! Me chamo **Joquebede Barboza** e sou **Formanda em Bacharelado em Administração**, **Técnica em Administração & Informática** e estudante de **Tecnologias Administrativas **.
...
Meu objetivo é construir uma carreira sólida integrando à Gestão Administrativa à Tecnologia da Informação, contribuindo para a transformação digital das organizações de sistemas público e privado por meio de soluções inteligentes e eficientes.
